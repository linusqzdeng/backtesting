...
class Contract:
    ...
    def __init__(self, contract: str, fromdate=None, todate=None):
        ...
        time_filepath = os.path.join(
                os.path.abspath("."),
                "trading_time", self.contract + "_1mtime.csv"
                )  # 1min data 
        ...
        self.filepath = os.path.join(
                os.path.abspath("."),
                "1m_main_contracts", self.contract + ".csv"
                )  # 1min data
...
todate = datetime.date(2016, 4, 15)

def set_contract_var():
    return Contract(contract_name, fromdate=fromdate, todate=todate)  # None for the limit of the timeframe 
